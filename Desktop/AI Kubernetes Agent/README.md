...
AI-powered on-demand Kubernetes troubleshooting platform.
...
**Suggested Fix:** Update `deployment.yaml` and add secret reference
...
| Pending Pods | Pods stuck waiting for scheduling |
| Resource Exhaustion | Node CPU/memory limits reached |
| Deployment Rollout Failures | Rollout stalled or unavailable replicas |
| Service Selector Mismatch | Service not routing to any pods |
| DNS Resolution Problems | Internal service discovery broken |
| Readiness/Liveness Probe Failures | Health checks failing |
| Networking Issues | Missing endpoints or misconfigured services |
